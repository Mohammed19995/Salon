...
@section('content')
    ...
    <div id="app">
        ...
        <employee-comp :countries="countries" :types="types" :categories="categories" :data="data" :shock_event="shock_event"
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h2 class="card-label">{{trans('admin.employees')}}</h2>
                </div>
...
@push('js')
    ...
    <script src="{{url('')}}/admin_assets/custom/js/employees/employee.js"></script>
@endpush
