        ...
        <div class="topbar">
            ...
            {{--<div class="dropdown">--}}
                ...
                {{--<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">--}}
                    {{--<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">--}}
											{{--<span class="svg-icon svg-icon-xl svg-icon-primary">--}}
												{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Code/Compiling.svg-->--}}
												{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"--}}
                                                     {{--viewBox="0 0 24 24" version="1.1">--}}
													{{--<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
														{{--<rect x="0" y="0" width="24" height="24"/>--}}
                ...
                {{--<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">--}}
                    {{--<form>--}}
                        ...
                        {{--<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"--}}
                             {{--style="background-image: url({{url('')}}/admin_assets/media/misc/bg-1.jpg)">--}}
                            {{--<!--begin::Title-->--}}
                                ...
                                {{--<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-primary mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-primary">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Home/Library.svg-->--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-warning mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-warning">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Write.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-success mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-success">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Group-chat.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-danger mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-danger">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/General/Attachment2.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-info mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-info">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Shield-user.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
                                    ...
                                    {{--<div class="d-flex align-items-center mb-6">--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-danger mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-danger">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Mail-notification.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
                                    ...
                                    {{--<div class="d-flex align-items-center mb-6">--}}
                                        ...
                                        {{--<div class="symbol symbol-40 symbol-light-success mr-5">--}}
																{{--<span class="symbol-label">--}}
																	{{--<span class="svg-icon svg-icon-lg svg-icon-success">--}}
																		{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Design/Bucket.svg-->--}}
																		{{--<svg xmlns="http://www.w3.org/2000/svg"--}}
                                                                             {{--width="24px" height="24px"--}}
                                                                             {{--viewBox="0 0 24 24" version="1.1">--}}
																			{{--<g stroke="none" stroke-width="1"--}}
            ...
            {{--<div class="dropdown">--}}
                ...
                {{--<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">--}}
                    {{--<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">--}}
											{{--<span class="svg-icon svg-icon-xl svg-icon-primary">--}}
												{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Media/Equalizer.svg-->--}}
												{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"--}}
                                                     {{--viewBox="0 0 24 24" version="1.1">--}}
													{{--<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
														{{--<rect x="0" y="0" width="24" height="24"/>--}}
                    ...
                    {{--<div class="row row-paddingless">--}}
                            ...
                            {{--<a href="#"--}}
                               {{--class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">--}}
													{{--<span class="svg-icon svg-icon-3x svg-icon-success">--}}
														{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Shopping/Euro.svg-->--}}
														{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px"--}}
                                                             {{--height="24px" viewBox="0 0 24 24" version="1.1">--}}
															{{--<g stroke="none" stroke-width="1" fill="none"--}}
                                                               {{--fill-rule="evenodd">--}}
                        ...
                        {{--<div class="col-6">--}}
                            {{--<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">--}}
													{{--<span class="svg-icon svg-icon-3x svg-icon-success">--}}
														{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Mail-attachment.svg-->--}}
														{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px"--}}
                                                             {{--height="24px" viewBox="0 0 24 24" version="1.1">--}}
															{{--<g stroke="none" stroke-width="1" fill="none"--}}
                                                               {{--fill-rule="evenodd">--}}
                        ...
                        {{--<div class="col-6">--}}
                            {{--<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">--}}
													{{--<span class="svg-icon svg-icon-3x svg-icon-success">--}}
														{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Shopping/Box2.svg-->--}}
														{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px"--}}
                                                             {{--height="24px" viewBox="0 0 24 24" version="1.1">--}}
															{{--<g stroke="none" stroke-width="1" fill="none"--}}
                                                               {{--fill-rule="evenodd">--}}
                        ...
                        {{--<div class="col-6">--}}
                            {{--<a href="#" class="d-block py-10 px-5 text-center bg-hover-light">--}}
													{{--<span class="svg-icon svg-icon-3x svg-icon-success">--}}
														{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Communication/Group.svg-->--}}
														{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px"--}}
                                                             {{--height="24px" viewBox="0 0 24 24" version="1.1">--}}
															{{--<g stroke="none" stroke-width="1" fill="none"--}}
                                                               {{--fill-rule="evenodd">--}}
            ...
            {{--<div class="topbar-item">--}}
                {{--<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" id="kt_quick_cart_toggle">--}}
										{{--<span class="svg-icon svg-icon-xl svg-icon-primary">--}}
											{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Shopping/Cart3.svg-->--}}
											{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"--}}
                                                 {{--viewBox="0 0 24 24" version="1.1">--}}
												{{--<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
													{{--<rect x="0" y="0" width="24" height="24"/>--}}
            ...
            {{--<div class="topbar-item">--}}
                {{--<div class="btn btn-icon btn-clean btn-lg mr-1" id="kt_quick_panel_toggle">--}}
										{{--<span class="svg-icon svg-icon-xl svg-icon-primary">--}}
											{{--<!--begin::Svg Icon | path:{{url('')}}/admin_assets/media/svg/icons/Layout/Layout-4-blocks.svg-->--}}
											{{--<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"--}}
                                                 {{--viewBox="0 0 24 24" version="1.1">--}}
												{{--<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
													{{--<rect x="0" y="0" width="24" height="24"/>--}}
                ...
                {{--<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">--}}
                    {{--<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">--}}
                        {{--<img class="h-20px w-20px rounded-sm"--}}
                             {{--src="{{url('')}}/admin_assets/media/svg/flags/226-united-states.svg" alt=""/>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<!--end::Toggle-->--}}
                {{--<!--begin::Dropdown-->--}}
                {{--<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">--}}
                    ...
                    {{--<ul class="navi navi-hover py-4">--}}
                        ...
                        {{--<li class="navi-item">--}}
                            {{--<a href="#" class="navi-link">--}}
													{{--<span class="symbol symbol-20 mr-3">--}}
														{{--<img src="{{url('')}}/admin_assets/media/svg/flags/226-united-states.svg" alt=""/>--}}
													{{--</span>--}}
                        ...
                        {{--<li class="navi-item active">--}}
                            {{--<a href="#" class="navi-link">--}}
													{{--<span class="symbol symbol-20 mr-3">--}}
														{{--<img src="{{url('')}}/admin_assets/media/svg/flags/128-spain.svg" alt=""/>--}}
													{{--</span>--}}
                        ...
                        {{--<li class="navi-item">--}}
                            {{--<a href="#" class="navi-link">--}}
													{{--<span class="symbol symbol-20 mr-3">--}}
														{{--<img src="{{url('')}}/admin_assets/media/svg/flags/162-germany.svg" alt=""/>--}}
													{{--</span>--}}
                        ...
                        {{--<li class="navi-item">--}}
                            {{--<a href="#" class="navi-link">--}}
													{{--<span class="symbol symbol-20 mr-3">--}}
														{{--<img src="{{url('')}}/admin_assets/media/svg/flags/063-japan.svg" alt=""/>--}}
													{{--</span>--}}
                        ...
                        {{--<li class="navi-item">--}}
                            {{--<a href="#" class="navi-link">--}}
													{{--<span class="symbol symbol-20 mr-3">--}}
														{{--<img src="{{url('')}}/admin_assets/media/svg/flags/195-france.svg" alt=""/>--}}
													{{--</span>--}}
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" v-text="admin.name"></span>
