...
class AddSalonRequest extends BaseRequest
{
    use MultiLangValidationTrait , RuleTrait , CustomValidationRulesTrait;
    ...
    public function all($keys = null)
    {
        ...
        $data['employee_ids'] = json_decode(  $data['employee_ids'], true);
